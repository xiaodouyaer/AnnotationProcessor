...
/**
 * Created by LiuChaoya on 2018/2/11 14:06.
 * email  1090969255@qq.com
 */

public class AnnotatedClass {
    private static class TypeUtil {
        static final ClassName BINDER = ClassName.get("com.chaoya.appapi", "ViewBinder");
        static final ClassName PROVIDER = ClassName.get("com.chaoya.appapi", "ViewFinder");
    }
